...
export { default as Thermometer } from 'lucide-solid/icons/thermometer'
export { default as Trash2 } from 'lucide-solid/icons/trash-2'
export { default as Wind } from 'lucide-solid/icons/wind'
export { default as X } from 'lucide-solid/icons/x'

export const BUTTON_ICON = { size: 18, strokeWidth: 2 } as const
export const INLINE_ICON = { size: 16, strokeWidth: 1.75 } as const
