...
const style = { step: 1, fill: 0.18, fillFalloff: 0.7, color: [0, 0, 0] as [number, number, number], window: 1, bicubic: true, fade: 1, gradient: [0.02, 0.06] as [number, number], speed: [80, 250] as [number, number], vector: false, ringKm: 0, tolerancePx: 0.25 }
